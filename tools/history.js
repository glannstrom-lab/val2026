            ...
            return `
              <div class="eu-party-row" style="--party-color: ${PARTY_COLORS[party]}">
                <div class="eu-party-info">
                  <img src="./assets/logos/${party}.png" alt="${party}" class="eu-party-logo" onerror="this.style.display='none'">
          ...
          ${partiesData.map(party => `
            <div class="leader-card" style="--party-color: ${party.farg}">
              <div class="leader-header">
                <img src="./assets/logos/${party.id}.png" alt="${party.kortnamn}" class="leader-party-logo" onerror="this.style.display='none'">

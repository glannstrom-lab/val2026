...
(function() {
  ...
  async function initCompare() {
    ...
    if (!loaded) {
      container.innerHTML = '<div class="error">Kunde inte ladda sakfrågedata. Kontrollera internetanslutningen och <a href="javascript:location.reload()">ladda om sidan</a>.</div>';
      return;
    }

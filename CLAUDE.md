...
- [x] **Content** — fakta, källor, partiinformation, valmanifest *(Cykel 1, 6, 10, 19, 27, 35)*
- [x] **Accessibility** — WCAG-fixar, screenreader-test, tangentbordsnavigation *(Cykel 2, 7, 13, 18, 24, 32)*
- [x] **Tools** — förbättringar av kompass/test/jämförelse/tidslinje *(Cykel 11, 16, 22, 26, 30, 34)*
...
Senast vald: **Content (Cykel 35, 2026-05-01)**
